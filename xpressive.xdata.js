var Xmpp;
(function (Xmpp) {
    var $field, $form, $item, $opt, Field, Form, Item, Option, __slice = [].slice, __bind = function (fn, me) {
return function () {
return fn.apply(me, arguments);        }    }, __indexOf = [].indexOf || function (item) {
...
(function (Xmpp) {
    var Item = (function () {
        ...
        Item.prototype.fromXML = function (xml) {
            var f, fields;
            xml = $(xml);
        ...
        Item.prototype.fromHTML = function (html) {
            var f;
            return new Item({
                fields: (function () {
    ...
    var Option = (function () {
        ...
        Option.prototype.fromXML = function (xml) {
            return new Option({
                label: ($(xml)).attr("label"),
                value: ($(xml)).text()
            });
        };
        Option.prototype.fromHTML = function (html) {
            return new Option({
    ...
    var Field = (function () {
        function Field(opt) {
            ...
            this.values = [];
            if(opt) {
                if(_ref = opt.type , __indexOf.call(this._types, _ref) >= 0) {
        ...
        Field.prototype.addValues = function (vals) {
            var multi, v, _ref;
            multi = (_ref = this.type , __indexOf.call(this._multiTypes, _ref) >= 0);
        ...
        Field.prototype.fromXML = function (xml) {
            var o, v;
            xml = $(xml);
            return new Field({
                type: xml.attr("type"),
        ...
        Field.prototype._htmlElementToFieldType = function (el) {
            var r, type;
            el = $(el);
        ...
        Field.prototype.fromHTML = function (html) {
            var el, f, txt, type;
            html = $(html);
    ...
    var Form = (function () {
        ...
        Form.prototype.fromXML = function (xml) {
        ...
        Form.prototype.fromHTML = function (html) {
